...
class RewardLoopManager:
    ...
    def compute_rm_score(self, data: DataProto) -> DataProto:
        ...
        # Keys every row carries, not row 0's: a mixed-domain batch (MOPD) is
        # scored by several verifiers at once and they return different keys --
        # the math grader adds extracted_gt and pred, if_eval its strict/loose
        # breakdown, code_eval_v2 neither. Indexing every row with row 0's keys
        # raises KeyError on the first row scored by a different verifier.
