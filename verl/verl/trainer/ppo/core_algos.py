...
# Imported for its registration side effects: `token_reward_direct`,
# `token_reward_direct_plus_grpo` advantage estimators and the `vanilla_topk`
# policy loss. Kept at the bottom of the module because those symbols import
# `register_adv_est` / `register_policy_loss` / `agg_loss` from here.
import verl.trainer.ppo.opd_core_algos  # noqa: E402,F401  isort:skip
